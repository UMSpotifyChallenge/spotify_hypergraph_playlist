...
- Save pick of map to featALL.pickle?
Construct a song=>LIST of feature 1 categories

Usage:
./buildFeatALLmap.py output.pickle input_feature.txt
python2.7 buildFeatALLmap.py featALLmap.pickle FeatureALL_hypergraph.txt
...
def getFeatALLMap(feature_file):
...
if __name__ == '__main__':
    ...
    with open(sys.argv[2]) as feature_file:
        featALLmap = getFeatALLMap(feature_file)
        pass
    with open(sys.argv[1], 'w') as f:
        ...
        pickle.dump({'X': featALLmap}, f) # save map to pickle
        pass
    pass
